...
export const PIPELINE_CONFIG = {
  ...
  techScore: {
    cardTop: 470,
    radar: { cx: W / 2, cy: 680, radius: 120 },
    radarZone: { top: 470, height: 420 },
    progressZone: { top: 920, itemHeight: 200 },
    summaryZone: { top: 2100, height: 200, lineHeight: 48 },
    dimNameX: 120,
    dimScoreX: 940,
    barX: 120,
    barWidth: 780,
