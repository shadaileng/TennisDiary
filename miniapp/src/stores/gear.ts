...
export const useGearStore = defineStore("gear", {
  ...
  actions: {
    ...
    async create(body: GearCreate): Promise<Gear> {
      ...
      try {
        logInfo("添加装备", { trace_id: traceId, category: body.category }, undefined, "gear_create", traceId);
        ...
        logError("装备添加失败", { trace_id: traceId, error: (e as Error).message }, undefined, "gear_create_failed", undefined, traceId);
        throw e;
      }
    },
    ...
    async update(id: number, body: GearUpdate): Promise<Gear> {
      ...
      try {
        ...
        logError("装备更新失败", { trace_id: traceId, gear_id: id, error: (e as Error).message }, undefined, "gear_update_failed", undefined, traceId);
        throw e;
      }
    },
