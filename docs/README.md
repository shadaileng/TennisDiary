...
| 126：小程序昵称输入隐私授权修复 | v2.0.0 | 方案 | `plans/126-小程序昵称输入隐私授权修复.md` | 删除手动隐私授权，依赖微信自动弹窗 + 渲染层错误全局埋点 | 📋 待执行 |
...
| 108-日记装备关联选择与手写 | 小程序前端 | 🚧 进行中 | 2026-08-23 | - |
...
| 126-小程序昵称输入隐私授权修复 | 小程序前端 | 📋 待执行 | 2026-09-02 | 删除手动隐私授权，依赖微信自动弹窗 + 渲染层错误全局埋点 |
