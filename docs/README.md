...
| 126：小程序昵称输入隐私授权修复 | v2.0.0 | 方案 | `plans/126-小程序昵称输入隐私授权修复.md` | 删除手动隐私授权，依赖微信自动弹窗 + 渲染层错误全局埋点 | 🏁 已完成 |
...
| 126-小程序昵称输入隐私授权修复 | 小程序前端 | 🏁 已完成 | 2026-09-02 | 删除手动隐私授权，依赖微信自动弹窗 + 渲染层错误全局埋点 |
